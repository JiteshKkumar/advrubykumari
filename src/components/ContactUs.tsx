...
const ContactUs: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Contact Us | Advocate Ruby Kumari</title>
        <meta name="description" content="Contact Best Advocate Ruby Kumari in Delhi for expert legal advice in family law, criminal defense, and corporate disputes." />
        <meta name="keywords" content="Contact Advocate Ruby Kumari, Lawyer in Delhi, Legal Consultation, Family Law, Criminal Defense, Corporate Disputes" />
                ...
                {[
                  ...
                  <div key={field.id}>
                    ...
                    <input
                      ...
                      className="mt-1 block w-full border border-gray-300 bg-white text-gray-900 caret-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm rounded"
                    />
                  </div>
                ))}
...
const InfoItem: React.FC<InfoItemProps> = ({ icon, title, text, note }) => (
